            ...
            <div class="col-sm-6">
                <div class="row" >
                    <ul class="nav nav-tabs"align="center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="adm_p_delete.php">Видалити</a>
                        </li>
                    </ul>
                </div>
                <div class="row after_menu"></div>
                <h2 align="center">Видалити випускника</h2>
                <div class="row after_menu"></div>
                <form method="post" action="adm_p_delete.php">
