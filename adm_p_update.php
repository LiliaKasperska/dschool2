            ...
            <div class="col-sm-6">
                <div class="row" >
                    <ul class="nav nav-tabs"align="center">
                        <li class="nav-item">
                            <a class="nav-link " href="adm_p_add.php">Додати</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="adm_p_update.php">Редагувати</a>
                        </li>
                        <li class="nav-item">
                ...
                <h2 align="center">Редагувати випускника</h2>
                <div class="row after_menu"></div>
                <form method="post" action="adm_p_update.php" enctype="multipart/form-data">
                    <select class="custom-select" name="selectpib">
                        <option selected>Виберіть випускника</option>
                    <?php 
                ...
                <br><hr><br>
                    <?php 
                        if(!empty($_POST['selectpib'])){
                            if($_POST['selectpib']!="Виберіть випускника"){
                                $a=$_POST['selectpib'];
                                $sql="SELECT * FROM people WHERE id='$a'";
                                $res=mysqli_query($connect,$sql);
                    ...
                    if(isset($_POST['789'])){
                        ...
                        $ppib=$_POST['ppib'];
                        $id=$result[0];
                        $sql="UPDATE people SET name='$pib', position='$ppib' WHERE id='$id'";
                        $res=mysqli_query($connect,$sql);
                        if($res){
                    ...
                    if(isset($_POST['123'])){
                        ...
                        $id=$result[0];
                        $sql="UPDATE people SET foto='$file' WHERE id='$id'";
                        $res=mysqli_query($connect,$sql);
                        if($res){
                            echo "Фото змінено";
                        }
