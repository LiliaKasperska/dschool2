            ...
            <div class="col-sm-6">
				<div class="row" >
                    <ul class="nav nav-tabs" align="center">
                        <li class="nav-item">
                            <a class="nav-link" href="adm_form.php">Дошкільний підрозділ</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="adm_form1.php">Дистанційне навчання</a>
                        </li>
                    </ul>
                </div>
                <br>
                ...
                <br>
				<?php 
				$sql="SELECT * FROM question WHERE type_id='2'";
